          ...
          <div>
            ...
            {!h ? (
              ...
              <>
                ...
                {h.sample_warning && (
                  <div style={{ marginTop: 6, fontSize: 12, color: TONE.warn, lineHeight: 1.5 }}>
                    ⚠ {h.sample_warning}
                  </div>
                )}
                {h.mean_pct < 0 && (
                  <div style={{ marginTop: 6, fontSize: 12, color: TONE.bad, lineHeight: 1.5 }}>
...
export function MomentumView() {
  ...
  return (
    <div style={{ padding: "8px 4px" }}>
      ...
      <div style={{ fontSize: 14, color: "var(--text-dim)", margin: "0 0 12px", lineHeight: 1.6 }}>
                  ...
                  <td style={{ padding: "8px 10px", fontWeight: 700, fontFamily: "var(--font-mono)" }}>
                    ...
                    {c.history && c.history.mean_pct < 0 && (
                      <span title="This rule has lost money on this symbol historically — open the row"
                            style={{ marginLeft: 6, color: TONE.bad, fontSize: 12 }}>⚠</span>
                    )}
                  </td>
